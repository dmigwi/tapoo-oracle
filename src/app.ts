...
// re-exports the control rather than the page reaching two modules. Every module on this path opens
...
//
//   createLogTabsInput      report-view -> log-tabs-control   the viewof element owning the tab state
//     |- log-tabs           loadNewLogTabFromUrl -> loadLogTabFields -> share-link.loadTapooLogFromUrl
//     |                     -> log-contract.parseTapooLogText, then sliceLogIntoRounds cuts the log
//     |                     into one RoundSlice per round. Nothing is answered yet.
...
//     |- log-tabs           roundReportFor answers the round on screen, once, and memoizes it:
//     |                     rubric-report.buildReport (rubric-engine.buildContext,
//     |                     rounds.buildLevels, rubric-report.answerRubric), plus
//     |                     log-contract.parseGameRound for the round's payloads
