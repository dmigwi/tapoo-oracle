...
function createReportWorkspaceRoot(readState) {
...
function rememberActiveReport(nextState) {
  const location = globalThis.location;
...
async function loadDraftReportTab({getState, setState, fetchText}) {
...
async function restoreSharedReport({getState, setState, fetchText}) {
  const location = globalThis.location;
...
function renderReportWorkspace(root, state, actions) {
...
function createReportNavigator(state, actions) {
...
function createReportListItem(tab, state, actions) {
...
function createReportActivePanel(state, actions) {
...
function createReportUrlForm(state, actions) {
